...
<body>
    ...
    <form action="" method= "POST">
       <input type="text"  class="autosuggest" name="keywords" id="email" value="<?php echo $ip_address; ?>" />
